...
const CATEGORY_SECTIONS: Record<string, (meta: CatalogMeta) => TemplateSection[]> = {
  financial: (meta) => [
    ...
    section("details", meta.name, [
      ...
      { id: "taxNotice", label: "Tax / Reporting Notice", type: "textarea" },
  ...
  legal: (meta) => [
    ...
    section("terms", `${meta.name} Terms`, [
      ...
      { id: "paymentTerms", label: "Payment / Consideration", type: "textarea" },
      ...
      { id: "governingLaw", label: "Governing Law (State)", type: "text", required: true, placeholder: "e.g. State of California" },
      { id: "disputeResolution", label: "Dispute Resolution", type: "text" },
    ]),
